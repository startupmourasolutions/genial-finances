                      ...
                      <p className="text-muted-foreground">Nenhuma dívida encontrada</p>
                         ...
                         <div className="flex items-start justify-between gap-4">
                           <div className="flex items-start gap-3 flex-1 min-w-0">
                             ...
                             <div className={`w-4 h-4 rounded-full flex-shrink-0 mt-1 ${debt.status === 'paid' ? 'bg-success shadow-lg shadow-success/50' : isOverdue(debt.due_date) ? 'bg-destructive animate-pulse shadow-lg shadow-destructive/50' : 'bg-warning shadow-lg shadow-warning/50'}`} />
