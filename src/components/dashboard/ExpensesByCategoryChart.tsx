...
export function ExpensesByCategoryChart() {
  ...
  return <Card className="shadow-card">
      ...
      <CardContent>
        {chartData.length > 0 ? <div className="h-48 sm:h-64 md:h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              minimumFractionDigits: 2
                ...
                <Legend wrapperStyle={{
              fontSize: '10px'
            }} iconType="circle" layout="horizontal" align="center" verticalAlign="bottom" />
              </PieChart>
            </ResponsiveContainer>
            
          </div> : <div className="flex items-center justify-center h-80 text-muted-foreground">
